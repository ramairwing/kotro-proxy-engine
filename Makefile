.PHONY: build test bench mock proxy run dev load-test cancel-audit rust-cancel-audit audit update-homebrew-shas clean docker-build docker-up docker-down
